...
<body>
  ...
  <section  style="width: 1536px;height: 675px; background-color: grey; background-image: url(images/stdlogin1.jpg);">
    ...
    <div class="box">
        <div class="container" >
              <div style="height: 350px; width: 400px; position: absolute; right: 50px; background-color: rgba(195,202,212,0.5); border-radius: 20px;">

          <form action="mail.php"   method="post">
            <div class="form-group" >
              <h1 style="font-size: 30px; font-family: cordana; text-align: center; font-weight: bold;">STUDENT PASSWORD RECOVERY :</h1><hr color="white">
