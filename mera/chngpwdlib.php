...
if(isset($_GET['f']))
{
	header("Refresh:0.1;url=chngpwdlib.php");
...
<html>
<head>
	<title> Change Librarian Passsword</title>
...
<body>
	...
	<section style="width: 1536px;height: 675px; background-color: grey; background-image: url(images/librarian1.jpg);"><br><br><br><br>
				<div style="height: 500px; width: 400px; position: absolute; right: 570px; background-color: rgba(200,200,200,0.8); border-radius: 20px;">
		<br><h2 style="color:white; font-family: candara;font-weight: bold; text-align: center;">CHANGE PASSWORD :</h2>
		<hr color="white" width="400" length="20">

	
	<form action="chngpwdlib1.php" method="post">                 <br><br>
