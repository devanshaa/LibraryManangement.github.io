...
if(isset($_GET['f']))
{
	header("Refrese:0.1;url=removebook.php");
	 echo '<script type="text/javascript">alert("BOOK  DELETED SUCCESSFULLY")</script>';
}
elseif (isset($_GET['g'])) {
	header("Refrese:0.1;url=removebook.php");
	 echo '<script type="text/javascript">alert("ID DOES NOT EXIST....PLEASE INSERT VALID ID")</script>';
}
...
<body>
	...
	<section style="width: 1536px;height: 675px; background-color: grey; background-image: url(images/librarian1.jpg);"><br><br><br><br><br><br>
		
		<div style="height: 220px; width: 400px; position: absolute; right: 570px; background-color: rgba(195,202,212,0.5); border-radius: 20px;">
		...
		<hr color="white" width="400" length="20">
			<form action="removebook1.php" method="post"> 
           ...
           <input type="text" class="form-control" name="id" style="width: 300px; margin: 0 auto;" id="inputEmail4" placeholder="Book Id" required>
           
           </div><div style="text-align: center;">

             <button name="add"  type="submit"  class="btn btn-danger" >Delete Book</button></div>
			</form>
