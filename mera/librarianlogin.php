...
if(isset($_GET['f']))
{
   ...
   header("Refresh:0.1;librarianlogin.php");
}
...
<body  onload="noBack();" 
	...
	<section  style="width: 1536px;height: 675px; background-color: grey; background-image: url(images/librarian1.jpg);">
		<br>
			<div class="box">
				<div class="container">
					<form action="librarianlogin1.php" method="post" onsubmit="return checkform(this);">
					<div style="height: 510px; width: 500px; position: absolute; right: 0px; top: -40px; background-color: rgba(150,163,154,0.5); border-radius: 20px;">

						<div class="form-group" >
							<h1 style="font-size: 30px; font-family: cordana; text-align: center; font-weight: bold;">LIBRARIAN LOGIN FORM :</h1><hr color="white">
...
return string.split(' ').join('');
					...
					<div class="form-group" style="text-align: center;font-size: 20px; font-weight: bold;" >
                            ...
                            <input type="submit" class="btn btn-danger" align="justify" value="Forgot Password" name="login"></form></div>
