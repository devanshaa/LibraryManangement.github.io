...
<body>
  ...
  <section  style="width: 1536px;height: 675px; background-color: grey; background-image: url(images/admin.jpg);">
    <br><br><br>
    <div class="box">
        <div class="container" >


            <div style="height: 260px; width: 400px; position: absolute; right: 50px; background-color: rgba(200,200,200,0.7); border-radius: 20px;">

          <form action="mail2.php"   method="post">
            <div class="form-group" >
              <h1 style="font-size: 30px; font-family: cordana; text-align: center; font-weight: bold;">ADMIN PASSWORD RECOVERY :</h1><hr color="white">
